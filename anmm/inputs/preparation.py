...
class Preparation(object):
    ...
    * Relation File: this file records the relationship between two texts, each line containing the label and a pair of ids.
    ...
    def run_with_one_corpus_for_quora(self, file_path,order):
        # hashid = {}
        corpus = {}
        rels = []
        ...
        for line in f:
            ...
            if order==2:
                ...
                qid1, qid2, label, q1, q2 = self.parse_line_for_quora(line, "\t")
            if q1 != 0:
                corpus[qid1] = q1
                corpus[qid2] = q2
    ...
    def run_with_one_corpus(self, file_path,order):
        hashid = {}
        corpus = {}
        rels = []
        f = codecs.open(file_path, 'r', encoding='utf8')
        for line in f:
            ...
            line = line.strip()
            if order==2:
                 t1, t2,label = self.parse_line(line)
            else:
