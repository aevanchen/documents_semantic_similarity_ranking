...
GLOVE='..'
python gen_w2v.py $GLOVE/wiki.simple.bin word_dict.txt embed_fasttext_d300
python norm_embed.py embed_fasttext_d300 embed_fasttext_d300_norm
...
python gen_binsum4anmm.py 100 # the default number of bin is 20
